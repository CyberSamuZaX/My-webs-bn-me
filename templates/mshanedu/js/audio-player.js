...
var RedAudioPlayer =
    /*#__PURE__*/
    function() {
        function RedAudioPlayer(player) {
            _classCallCheck(this, RedAudioPlayer);

            this.audioPlayer = document.querySelector(player);
            var audioElement = this.audioPlayer.innerHTML;
            this.audioPlayer.classList.add('red-audio-player');
            this.audioPlayer.innerHTML = RedAudioPlayer.getTemplate() + audioElement;
        ...
        _createClass(RedAudioPlayer, [{
            ...
            value: function initEvents() {
                ...
                this.player.addEventListener('loadedmetadata', function() {
                    _this.totalTime.textContent = RedAudioPlayer.formatTime(self.player.duration);
                });
            ...
            value: function updateProgress() {
                ...
                this.currentTime.textContent = RedAudioPlayer.formatTime(current);
            }
        }, {
            key: "updateVolume",
        ...
        return RedAudioPlayer;
    }();

window.RedAudioPlayer = RedAudioPlayer;